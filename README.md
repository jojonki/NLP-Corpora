...
- [CommonsenseQA, 2018](https://www.tau-nlp.org/commonsenseqa)
CommonsenseQA is a new QA dataset that contains 9,500 examples and aims to test commonsense knowledge.
